...
<h3 class="text-center">Hobbies &amp; Leisure</h3>
...
<h3 class="text-center mt-3">Academic</h3>

<div class="d-flex flex-wrap justify-content-center">

  <a class="btn btn-light btn-lg btn-portal m-2" href="https://twitter.com/mmbollmann">
    <i class="fab fa-twitter-square pb-2"></i>
    <h5 class="mb-n1">Twitter</h5>
  </a>

  <a class="btn btn-light btn-lg btn-portal m-2" href="https://github.com/mbollmann">
    <i class="fab fa-github pb-2"></i>
    <h5 class="mb-n1">GitHub</h5>
  </a>

  <a class="btn btn-light btn-lg btn-portal m-2" href="https://scholar.google.com/citations?user=l3pm9QkAAAAJ">
    <i class="ai ai-google-scholar pb-2"></i>
    <h5 class="mb-n1">Google Scholar</h5>
  </a>

  <a class="btn btn-light btn-lg btn-portal m-2" href="https://www.semanticscholar.org/author/Marcel-Bollmann/34887843">
    <i class="ai ai-semantic-scholar-square pb-2"></i>
    <h5 class="mb-n1">Semantic Scholar</h5>
  </a>
