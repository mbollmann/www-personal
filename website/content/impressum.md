...
Die durch den Seitenbetreiber erstellten bzw. verwendeten Inhalte und Werke auf
...
Urheberrechtes bedürfen der Zustimmung des jeweiligen Autors
...
Sie trotzdem auf eine Urheberrechtsverletzung aufmerksam werden, bitte ich um
einen entsprechenden Hinweis. Bei Bekanntwerden von Rechtsverletzungen werde
...
hiermit ausdrücklich widersprochen.**  Der Betreiber der Seite behält sich
...
to statutory provisions, I am furthermore responsible for my own content on
these web pages. In this context, please note that I am accordingly not obliged
to monitor merely the transmitted or saved information of third parties, or
investigate circumstances pointing to illegal activity. My obligations to remove
...
to me at the time of linking. Should any legal infringement become known to me,
I will remove the respective link immediately.
...
rights. Individual reproductions of a work are allowed only for private use, so
must not serve either directly or indirectly for earnings. Unauthorized
utilization of copyrighted works is punishable (§ 106 of the copyright law).

#### Privacy protection

Usage of these web pages does generally not require the submission of personal data.  To the extent that personal data (e.g. name, address, or e-mail address) is requested, this is done on voluntary basis whenever possible. This data is never forwarded to third parties without your express permission.
Please note that transmitting data over the internet (e.g. via e-mail communication) can be subject to security vulnerabilities outside of my control.
**I do not consent to the usage of contact details in this legal notice for purposes of unsolicited advertisement (e.g. spam mails) or informational brochures.**  I reserve the right to take legal measures in case of unsolicited sending of advertising materials.
